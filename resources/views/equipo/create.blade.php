...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{route('equipo.create')}}">Crear</a>
                </li>
            </ul>
          </div>
        </div>
    ...
    <div class="d-flex justify-content-center align-items-center flex-column" style="height: calc(100vh - 56px);">
        ...
        <form class="w-25" action="{{route('equipo.store')}}" method="POST">
            @csrf
            ...
            <div class="form-floating mb-3">
                <input name="estadio" type="text" class="form-control" id="estadio" placeholder="estadio">
                <label for="estadio">Estadio</label>
            </div>
            <div class="form-floating mb-3">
                <input name="aforo" type="integer" class="form-control" id="aforo" placeholder="aforo">
